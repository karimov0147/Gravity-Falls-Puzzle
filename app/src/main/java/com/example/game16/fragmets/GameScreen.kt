...
class GameScreen : Fragment() , View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_game_screen, container, false)
    ...
    override fun onClick(clicked: View) {
        if (clickable){
            ...
            if (emptyPosition - pos == 1 && emptyPosition % 4 != 0) {
                ...
                startAnim(clicked, "x", clicked.x + (clicked.width+convertDpToPixel(8f,mContext)))
                ...
                emptyPosition = pos
                binding.textView.text = "Step : ${counter++}"
                startAnim(clicked, "y", clicked.y + (clicked.height+convertDpToPixel(8f,mContext)))
            } else if (emptyPosition - pos == -4) {
                clicked.tag = emptyPosition
                emptyPosition = pos
                binding.textView.text = "Step : ${counter++}"
...
//}
            var obj = Score(name,step, text.toString() , "Medium")
